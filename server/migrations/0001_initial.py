    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memory', models.CharField(max_length=50, verbose_name='RAM')),
                ('cpu', models.CharField(max_length=50, verbose_name='CPU')),
                ('storage', models.CharField(max_length=50, verbose_name='HDD')),
                ...
                ('image', models.FileField(blank=True, default=None, upload_to=server.models.save_directory_path, verbose_name='Şəkil')),
